...
<p>This script attempts to create a service to boot on every launch, you may ahve to do this manually, try and find main.py it should be in flowlist/web</p>
